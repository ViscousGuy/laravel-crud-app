                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update', $product->id) }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" id="" cols="30" rows="5" placeholder="Decription">{{ old('description', $product->description) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                @if($product->image)
                                            <img width="w-50 my-3" src="{{ asset('uploads/products/'.$product->image)}}" alt="product_image">
                                @endif
                                @error('image')
                                    <p class="invalid feedback">{{ $message }}</p>
                                @enderror
